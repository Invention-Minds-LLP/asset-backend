    ...
    const defaults = [
      ...
      { name: "finance-analytics", label: "Finance & Analytics", icon: "pi pi-indian-rupee", path: "/finance", sortOrder: 9,
        items: [
          ...
          { name: "depreciation-audit",    label: "Depreciation Audit",   path: "/depreciation-audit",    icon: "pi pi-verified",   sortOrder: 7 },
          { name: "fixed-assets-schedule", label: "Fixed Assets Schedule", path: "/fixed-assets-schedule", icon: "pi pi-table",           sortOrder: 8 },
          { name: "finance-centre",        label: "Finance Centre",        path: "/finance-centre",        icon: "pi pi-building-columns", sortOrder: 9 },
          { name: "reports",               label: "Reports",               path: "/reports",               icon: "pi pi-file",             sortOrder: 10 },
          { name: "data-export",           label: "Data Export",           path: "/data-export",           icon: "pi pi-download",         sortOrder: 11 },
        ]
      },
      ...
      { name: "operations", label: "Operations", icon: "pi pi-cog", path: "/operations", sortOrder: 11,
        items: [
          ...
          { name: "bulk-operations", label: "Bulk Operations",     path: "/quick-actions",   icon: "pi pi-bolt",         sortOrder: 6 },
        ]
      },
      ...
      { name: "administration", label: "Administration", icon: "pi pi-shield", path: "/admin", sortOrder: 12,
        items: [
          ...
          { name: "subtype-support",           label: "Sub-Type Support & Assets", path: "/subtype-support",           icon: "pi pi-sitemap",      sortOrder: 4 },
          { name: "master-settings",           label: "Master Settings",           path: "/master-settings",           icon: "pi pi-cog",          sortOrder: 5 },
          { name: "approval-config",           label: "Approval Config",           path: "/approval-config",           icon: "pi pi-check-circle", sortOrder: 5 },
          { name: "module-access",             label: "Module Access",             path: "/module-access",             icon: "pi pi-lock",         sortOrder: 6 },
          { name: "system-config",             label: "System Config",             path: "/tenant-config",             icon: "pi pi-sliders-v",    sortOrder: 7 },
          { name: "user-activity",             label: "User Activity",             path: "/user-activity",             icon: "pi pi-users",        sortOrder: 8 },
          { name: "audit-trail",               label: "Audit Trail",               path: "/audit-trail",               icon: "pi pi-history",      sortOrder: 9 },
