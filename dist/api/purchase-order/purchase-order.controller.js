...
exports.getPOAmendments = exports.amendPO = exports.createPOFromIndent = exports.cancelPO = exports.sendToVendor = exports.approvePO = exports.updatePurchaseOrder = exports.createPurchaseOrder = exports.getPurchaseOrderById = exports.getAllPurchaseOrders = void 0;
...
function generatePONumber() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const latest = yield prismaClient_1.default.purchaseOrder.findFirst({
...
const getPurchaseOrderById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const po = yield prismaClient_1.default.purchaseOrder.findUnique({
...
const createPurchaseOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { vendorId, departmentId, indentId, deliveryDate, paymentTerms, shippingAddress, notes, lines, } = req.body;
        if (!vendorId) {
        ...
        if (indentId) {
            const indent = yield prismaClient_1.default.assetIndent.findUnique({ where: { id: Number(indentId) } });
            if (!indent) {
                res.status(400).json({ message: "Indent not found" });
                return;
            }
            // Check if a PO already exists for this indent (prevent duplicates)
            const existingPO = yield prismaClient_1.default.purchaseOrder.findFirst({
            ...
            const cfg = yield prismaClient_1.default.tenantConfig.findUnique({ where: { key: "MANDATORY_INDENT_BEFORE_PO" } });
        ...
        const lineData = lines.map((l, idx) => {
            ...
            return {
                ...
                lineTotal,
                pendingQty: qty,
                hsnCode: (_a = l.hsnCode) !== null && _a !== void 0 ? _a : null,
                specifications: (_b = l.specifications) !== null && _b !== void 0 ? _b : null,
            };
        });
        const totalAmount = subtotal + taxAmount;
        // Determine required approval level based on amount
        const approvalLevel = yield (0, approvalConfigHelper_1.getRequiredApprovalLevel)("PURCHASE_ORDER", totalAmount);
        const po = yield prismaClient_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            const created = yield tx.purchaseOrder.create({
                data: {
                    poNumber,
                    ...
                    paymentTerms: paymentTerms !== null && paymentTerms !== void 0 ? paymentTerms : null,
                    shippingAddress: shippingAddress !== null && shippingAddress !== void 0 ? shippingAddress : null,
        ...
        (0, audit_trail_controller_1.logAction)({ entityType: "PURCHASE_ORDER", entityId: po.id, action: "CREATE", description: `PO ${po.poNumber} created, amount ${totalAmount}`, performedById: user.employeeDbId });
        // Notify HODs about new PO pending approval
        const hodIds = yield (0, notificationHelper_1.getDepartmentHODs)(po.departmentId);
        (0, notificationHelper_1.notify)({ type: "PO_APPROVAL", title: "New PO Pending Approval", message: `PO ${po.poNumber} (${(0, notificationHelper_1.formatCurrency)(totalAmount)}) requires approval`, recipientIds: hodIds, createdById: user.employeeDbId, channel: "BOTH", templateCode: "PO_APPROVAL", templateData: { poNumber: po.poNumber, amount: (0, notificationHelper_1.formatCurrency)(totalAmount) } });
...
const updatePurchaseOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existing = yield prismaClient_1.default.purchaseOrder.findUnique({ where: { id: poId } });
        if (!existing) {
            res.status(404).json({ message: "Purchase order not found" });
            return;
        }
        ...
        const updated = yield prismaClient_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (lineData.length > 0) {
                yield tx.purchaseOrderLine.deleteMany({ where: { purchaseOrderId: poId } });
            }
            const po = yield tx.purchaseOrder.update({
                where: { id: poId },
                data: Object.assign(Object.assign({ vendorId: vendorId ? Number(vendorId) : undefined, departmentId: departmentId !== undefined ? (departmentId ? Number(departmentId) : null) : undefined, indentId: indentId !== undefined ? (indentId ? Number(indentId) : null) : undefined, deliveryDate: deliveryDate !== undefined ? (deliveryDate ? new Date(deliveryDate) : null) : undefined, paymentTerms: paymentTerms !== undefined ? paymentTerms : undefined, shippingAddress: shippingAddress !== undefined ? shippingAddress : undefined, notes: notes !== undefined ? notes : undefined }, (lineData.length > 0 ? { subtotal, taxAmount, totalAmount } : {})), { updatedById: user.employeeDbId, lines: lineData.length > 0 ? { create: lineData } : undefined }),
                include: { lines: true },
            });
            return po;
        }));
...
// ── PATCH /:id/approve ───────────────────────────────────────────────
const approvePO = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const poId = Number(req.params.id);
        ...
        const po = yield prismaClient_1.default.purchaseOrder.findUnique({ where: { id: poId } });
        if (!po) {
            res.status(404).json({ message: "Purchase order not found" });
            return;
        }
        ...
        const approvalChain = {
            HOD: {
                ...
                fields: { hodApprovedById: user.employeeDbId, hodApprovedAt: new Date(), hodRemarks: remarks !== null && remarks !== void 0 ? remarks : null },
            },
            MANAGEMENT: {
                requiredStatus: "HOD_APPROVED",
                newStatus: requiredIdx <= 1 ? "MGMT_APPROVED" : "MGMT_APPROVED",
                fields: { mgmtApprovedById: user.employeeDbId, mgmtApprovedAt: new Date(), mgmtRemarks: remarks !== null && remarks !== void 0 ? remarks : null },
            },
            COO: {
                requiredStatus: "MGMT_APPROVED",
                newStatus: "COO_APPROVED",
                fields: { cooApprovedById: user.employeeDbId, cooApprovedAt: new Date(), cooRemarks: remarks !== null && remarks !== void 0 ? remarks : null },
            },
            CFO: {
                requiredStatus: "COO_APPROVED",
                newStatus: "CFO_APPROVED",
                fields: { cfoApprovedById: user.employeeDbId, cfoApprovedAt: new Date(), cfoRemarks: remarks !== null && remarks !== void 0 ? remarks : null },
            },
        };
        ...
        const updated = yield prismaClient_1.default.purchaseOrder.update({
            where: { id: poId },
            data: Object.assign(Object.assign({}, chain.fields), { status: chain.newStatus }),
        });
        ...
        (0, audit_trail_controller_1.logAction)({ entityType: "PURCHASE_ORDER", entityId: poId, action: "APPROVE", description: `PO ${po.poNumber} approved by ${level}`, performedById: user.employeeDbId });
        // Notify admins if next approval level needed
        if (nextLevel) {
            const adminIds = yield (0, notificationHelper_1.getAdminIds)();
            (0, notificationHelper_1.notify)({ type: "PO_APPROVAL", title: "PO Approved by " + level, message: `PO ${po.poNumber} approved by ${level}, needs ${nextLevel} approval`, recipientIds: adminIds, createdById: user.employeeDbId });
        }
        res.json(Object.assign(Object.assign({}, updated), { _approvalInfo: {
                requiredLevel,
                currentLevel: level,
                nextLevel,
...
// ── PATCH /:id/send ──────────────────────────────────────────────────
const sendToVendor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        const poId = Number(req.params.id);
        const po = yield prismaClient_1.default.purchaseOrder.findUnique({ where: { id: poId } });
        ...
        (0, audit_trail_controller_1.logAction)({ entityType: "PURCHASE_ORDER", entityId: poId, action: "STATUS_CHANGE", description: `PO ${po.poNumber} sent to vendor`, performedById: (_a = req.user) === null || _a === void 0 ? void 0 : _a.employeeDbId });
        // Notify PO creator that PO has been sent to vendor
        (0, notificationHelper_1.notify)({ type: "PO_APPROVAL", title: "PO Sent to Vendor", message: `PO ${po.poNumber} has been sent to vendor`, recipientIds: [po.createdById].filter(Boolean), createdById: (_b = req.user) === null || _b === void 0 ? void 0 : _b.employeeDbId, channel: "BOTH", templateCode: "PO_APPROVED", templateData: { poNumber: po.poNumber, amount: '' } });
        res.json(updated);
    }
    catch (error) {
...
exports.sendToVendor = sendToVendor;
// ── PATCH /:id/cancel ────────────────────────────────────────────────
const cancelPO = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    try {
        const poId = Number(req.params.id);
        const po = yield prismaClient_1.default.purchaseOrder.findUnique({ where: { id: poId } });
        ...
        (0, audit_trail_controller_1.logAction)({ entityType: "PURCHASE_ORDER", entityId: poId, action: "STATUS_CHANGE", description: `PO ${po.poNumber} cancelled`, performedById: (_a = req.user) === null || _a === void 0 ? void 0 : _a.employeeDbId });
        // Notify PO creator + HOD about cancellation
        const cancelPoNotifyIds = [];
        if (po.createdById)
            cancelPoNotifyIds.push(po.createdById);
        const cancelPoHodIds = yield (0, notificationHelper_1.getDepartmentHODs)(po.departmentId);
        const allCancelIds = [...new Set([...cancelPoNotifyIds, ...cancelPoHodIds])].filter(id => { var _a; return id !== ((_a = req.user) === null || _a === void 0 ? void 0 : _a.employeeDbId); });
        if (allCancelIds.length > 0) {
            (0, notificationHelper_1.notify)({ type: "PO_APPROVAL", title: "PO Cancelled", message: `PO ${po.poNumber} (${(0, notificationHelper_1.formatCurrency)(Number((_b = po.totalAmount) !== null && _b !== void 0 ? _b : 0))}) has been cancelled`, recipientIds: allCancelIds, createdById: (_c = req.user) === null || _c === void 0 ? void 0 : _c.employeeDbId });
        }
        res.json(updated);
    }
    catch (error) {
...
const createPOFromIndent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = mustUser(req);
        ...
        const po = yield prismaClient_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const created = yield tx.purchaseOrder.create({
                data: {
                    poNumber,
                    vendorId: Number(vendorId),
                    departmentId: (_a = indent.departmentId) !== null && _a !== void 0 ? _a : null,
                    indentId,
                    deliveryDate: (_b = indent.requiredByDate) !== null && _b !== void 0 ? _b : null,
                    notes: (_c = indent.justification) !== null && _c !== void 0 ? _c : null,
                    subtotal: lineTotal,
                    taxAmount: 0,
                    totalAmount: lineTotal,
                    originalAmount: lineTotal,
                    approvalLevel: yield (0, approvalConfigHelper_1.getRequiredApprovalLevel)("PURCHASE_ORDER", lineTotal),
                    status: "DRAFT",
                    createdById: user.employeeDbId,
                    lines: {
                        create: [
                            {
                                ...
                                assetCategoryId: (_d = indent.assetCategoryId) !== null && _d !== void 0 ? _d : null,
                                quantity: qty,
                                unitPrice,
                                taxPercent: 0,
                                lineTotal,
                                pendingQty: qty,
                                specifications: (_e = indent.specifications) !== null && _e !== void 0 ? _e : null,
                            },
                        ],
                    },
                },
        ...
        (0, audit_trail_controller_1.logAction)({ entityType: "PURCHASE_ORDER", entityId: po.id, action: "CREATE", description: `PO ${po.poNumber} created from indent #${indentId}`, performedById: user.employeeDbId });
        res.status(201).json(po);
    }
    catch (error) {
...
exports.createPOFromIndent = createPOFromIndent;
// ── PATCH /:id/amend — Amend PO (cost revision) ────────────────────
const amendPO = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const user = mustUser(req);
        const poId = Number(req.params.id);
        ...
        const previousAmount = Number((_a = po.totalAmount) !== null && _a !== void 0 ? _a : 0);
        ...
        const newApprovalLevel = yield (0, approvalConfigHelper_1.getRequiredApprovalLevel)("PURCHASE_ORDER", newTotalAmount);
        const result = yield prismaClient_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            // Create amendment record
            const amendment = yield tx.purchaseOrderAmendment.create({
                data: {
                    purchaseOrderId: poId,
                    amendmentNumber: ((_a = po.amendmentCount) !== null && _a !== void 0 ? _a : 0) + 1,
                    reason,
                    previousAmount,
            ...
            for (const ld of lineData) {
                yield tx.purchaseOrderLine.create({
                    data: Object.assign({ purchaseOrderId: poId }, ld),
                });
            }
            // Update PO
        ...
        (0, audit_trail_controller_1.logAction)({ entityType: "PURCHASE_ORDER", entityId: poId, action: "UPDATE", description: `PO ${po.poNumber} amended (#${result.amendment.amendmentNumber}), amount ${previousAmount} -> ${newTotalAmount}`, performedById: user.employeeDbId });
        // Notify PO creator about amendment
        if (po.createdById && po.createdById !== user.employeeDbId) {
            (0, notificationHelper_1.notify)({ type: "PO_APPROVAL", title: "PO Amended", message: `PO ${po.poNumber} has been amended (#${result.amendment.amendmentNumber}). New amount: ${(0, notificationHelper_1.formatCurrency)(newTotalAmount)}. Reason: ${reason}`, recipientIds: [po.createdById], createdById: user.employeeDbId });
        }
        res.json(Object.assign(Object.assign({}, result.po), { _amendment: {
...
const getPOAmendments = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const poId = Number(req.params.id);
        const amendments = yield prismaClient_1.default.purchaseOrderAmendment.findMany({
...
exports.getPOAmendments = getPOAmendments;
