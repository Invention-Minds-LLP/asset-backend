...
router.get("/stats", authMiddleware_1.authenticateToken, warranty_controller_1.getWarrantyStats);
...
router.post("/:assetId/renew", warranty_controller_1.renewWarranty);
router.get("/:assetId/history", warranty_controller_1.getWarrantyHistoryByAssetId);
