...
const directory_sync_routes_1 = __importDefault(require("./api/directory-sync/directory-sync.routes"));
const external_auditor_routes_1 = __importDefault(require("./api/external-auditor/external-auditor.routes"));
const external_audit_routes_1 = __importDefault(require("./api/external-audit/external-audit.routes"));
...
app.use("/api/directory-sync", directory_sync_routes_1.default);
app.use("/api/external-auditors", external_auditor_routes_1.default);
app.use("/api/external-audit", external_audit_routes_1.default);
